...
class MSC_External_Links_Settings {
    ...
    public static function render_landing_page() {
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__( 'Site Care', 'msc-external-links' ) . '</h1>';
    ...
    public function render_page() {
        ...
        <div class="wrap">
            ...
            <?php if ( isset( $_GET['updated'] ) ) : ?>
                <div class="notice notice-success is-dismissible"><p><?php esc_html_e( 'Settings saved.', 'msc-external-links' ); ?></p></div>
            <?php endif; ?>
            ...
            <form method="post" action="">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="mscel[excluded]" rows="6" class="large-text" placeholder="example.com&#10;subdomain.example.org"><?php echo esc_textarea( $options['excluded'] ); ?></textarea>
                ...
                <?php submit_button( __( 'Save Settings', 'msc-external-links' ), 'primary', 'mscel_settings_submit' ); ?>
            </form>
        </div>
        <?php
    }
...
if ( ! function_exists( 'msc_render_combined_upgrade_page' ) ) {
    function msc_render_combined_upgrade_page() {
        ...
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__( 'Upgrade to Pro', 'msc-external-links' ) . '</h1>';
        echo '<p>' . esc_html__( 'Upgrade individual modules to unlock more features for each plugin.', 'msc-external-links' ) . '</p>';
        if ( empty( $sections ) ) {
            echo '<p>' . esc_html__( 'No upgrades available.', 'msc-external-links' ) . '</p>';
        } else {
